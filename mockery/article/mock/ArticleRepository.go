...
func (_m *ArticleRepository) Fetch(ctx context.Context, cursor string, num int64) ([]article.Article, string, error) {
	...
	var r1 string
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int64) ([]article.Article, string, error)); ok {
...
func (_m *ArticleRepository) Store(ctx context.Context, a *article.Article) error {
	ret := _m.Called(ctx, a)
