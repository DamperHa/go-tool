...
type StreamServiceClient interface {
	List(ctx context.Context, in *StreamPoint, opts ...grpc.CallOption) (StreamService_ListClient, error)
...
func (c *streamServiceClient) List(ctx context.Context, in *StreamPoint, opts ...grpc.CallOption) (StreamService_ListClient, error) {
...
type StreamServiceServer interface {
	List(*StreamPoint, StreamService_ListServer) error
...
func (UnimplementedStreamServiceServer) List(*StreamPoint, StreamService_ListServer) error {
