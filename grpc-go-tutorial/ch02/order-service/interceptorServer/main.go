...
import (
	"context"
	"fmt"
	pb "go-tool/grpc-go-tutorial/ch02/order-service/interceptorServer/ecommerce"
	"io"
	"log"
	"net"
	"strings"
...
func orderUnaryServerIntercept(ctx context.Context, req interface{}, info *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (interface{}, error) {
	log.Println("=======[Server Interceptor]", info.FullMethod)
	log.Printf("Pre Porc Message:%s", req)
...
func main() {
	...
	s := grpc.NewServer(
		grpc.UnaryInterceptor(orderUnaryServerIntercept),
